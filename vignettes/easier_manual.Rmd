...
We are going to use the systems-based signatures computed previously to predict patients' immune response. `predict_immune_response` returns compute predictions for single system-based signatures and pairwise combinations of these system-based signatures. 
