...
## Compute quantitative descriptros of the TME
...
```{r, eval=TRUE}
output_evaluation_with_resp <- assess_immune_response(predictions_immune_response = predictions_immune_response,
...
```{r, eval=TRUE}
output_evaluation_no_resp <- assess_immune_response(predictions_immune_response = predictions_immune_response,
                                                    RNA_tpm = RNA_tpm,
                                                    TMB_values = TMB,
                                                    easier_with_TMB = TRUE)
# inspect output
