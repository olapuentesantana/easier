...
```{r eval = FALSE}
tasks <- c("CYT", "Roh_IS", "chemokines", "Davoli_IS", "IFNy", "Ayers_expIS", "Tcell_inflamed", "RIR"
           , "TLS")
#tasks_values <- compute_gold_standards(RNA_tpm = dataset_mariathasan@tpm, 
#                                      list_gold_standards = tasks)

tasks_values <- compute_gene_signatures(dataset_mariathasan@tpm, selected_signatures=tasks, verbose=T)
```
