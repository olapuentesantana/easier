...
#' signature (TLS) score
#'
#' This function calculates TLS score as the geometric-mean
#' of the expression of its signature genes.
#'
...
#'
#' @return A numeric matrix with samples in rows and TLS score
#' in a column.
#'
#' @examples
#'
